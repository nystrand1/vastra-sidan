...
export default function BandAndCard({
  ...
  return (
    <>
      <group position={[0, 4, 0]}>
        ...
        <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          ...
          <group
            ...
            <mesh geometry={(nodes.card as THREE.Mesh).geometry} position={[0, 0, 0]} material={materials.metal} material-roughness={0.3}>
      ...
      <mesh ref={band}>
        <meshLineGeometry />
        <meshLineMaterial color="white" resolution={resolution} useMap={1} map={texture} repeat={repeat} lineWidth={1} />
      </mesh>
    </>
  )
}