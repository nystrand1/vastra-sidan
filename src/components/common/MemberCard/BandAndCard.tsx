...
export default function BandAndCard({
  ...
  const band = useRef() as RefObject<
    THREE.Mesh & { geometry: { setPoints: (points: THREE.Vector3[]) => void } }
  >;
            ...
            >
              ...
              <Center scale={0.5} position={[0.5, 0.45, 0]}>
                <Html
                  ...
                  transform
                  className={twMerge(
                    "m-auto flex w-36 whitespace-nowrap text-right text-white opacity-0 transition-opacity delay-300",
                    flipped ? "animate-pulse opacity-100" : ""
                  )}
                  scale={0.2}
